...
const ProductsList = ({ filteredProducts }: { filteredProducts: any[] }) => {
  ...
  const [isTable, setIsTable] = React.useState<boolean>(true);
          ...
          <div className="relative overflow-x-auto bg-gray-50 rounded-xl">
                    ...
                    <td className="px-6 py-4 flex items-center space-x-3">
                      ...
                      <button
                        onClick={() => {
                          ...
                          navigate(
                            `/dashboard?deleteId=${product.id}&name=${product.name}`
                          );
                        }}
            ...
            <div className="flex justify-between items-center w-full px-6 py-4">
              <div className="text-sm text-gray-500">
                {currentPage} of {totalPages} pages | {filteredProducts?.length}{" "}
                products
              </div>
              <Pagination
                active={currentPage}
